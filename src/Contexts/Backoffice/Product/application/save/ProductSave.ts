...
export class ProductSave {
    ...
    async run({ id, structure, is_discountable, is_public, parent, title, description, meta_title, meta_description, product_class, categories, rating, created_at }: Params): Promise<void> {
